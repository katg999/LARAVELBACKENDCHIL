            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <h3 class="text-primary">{{ $invitation->healthFacility->name }}</h3>
                        <p class="text-muted">
                            As: <strong>{{ ucwords(str_replace('-', ' ', str_replace('health-facility-', '', $invitation->role))) }}</strong>
                        </p>
                    </div>

                    <form action="{{ route('health-facility.invitation.accept.post', $invitation->token) }}" method="POST">
                        @csrf
