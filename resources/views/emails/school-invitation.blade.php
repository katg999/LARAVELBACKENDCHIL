...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p>You have been invited to join the <strong>{{ $school->name }}</strong> staff team on the KETI AI Healthcare Platform.</p>
            ...
            <ul>
                @if(str_contains($invitation->role, 'admin'))
                    <li>📊 School dashboard and analytics</li>
                ...
                @else
                    ...
                    <li>📋 Student health records (view only)</li>
                    <li>🏥 Doctor appointments</li>
                @endif
            </ul>
