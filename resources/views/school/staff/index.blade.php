            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <i class="mdi mdi-account-group icon-xl text-success"></i>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <h5 class="mb-0">{{ $school->admins()->count() }}</h5>
                        </div>
                        <i class="mdi mdi-shield-account icon-xl text-primary"></i>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <div class="stat-label mb-2">Staff Members</div>
                            <h5 class="mb-0">{{ $school->staff()->count() }}</h5>
                        </div>
                        <i class="mdi mdi-account icon-xl text-info"></i>
                    </div>
                </div>
            </div>
        </div>
